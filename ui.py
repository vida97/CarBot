...
# Menu bar
    ...
    # Options
        ...
        color_theme.add_command(label="White",command=self.color_theme_white) 
        ...
        self.entry_field.pack(fill=X, padx=3, pady=3, ipady=3,)
...
#-----------------------------------------------------------------------------------------------------------------------------        
    ...
    def msg(self):
        tkinter.messagebox.showinfo("I'm Carbot")

    def about(self):
        tkinter.messagebox.showinfo("I'm Carbot. The bot who knows everything about cars")
